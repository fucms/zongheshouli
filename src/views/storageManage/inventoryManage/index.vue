  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form :inline="true" :model="listQuery" class="demo-form-inline">
          <el-form-item label="日志ID">
            <el-input v-model="listQuery.filter1" placeholder="请输入日志ID" />
          </el-form-item>
          <el-form-item label="账户">
            <el-input v-model="listQuery.filter2" placeholder="请输入账户" />
          </el-form-item>
        </el-form>
        <el-form-item>
      ...
      >
        ...
        <el-table-column label="账户" prop="type3" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code2 }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作用户" prop="type3" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code4 }}</span>
          </template>
        </el-table-column>
        <el-table-column label="操作内容" prop="type3" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code5 }}</span>
          </template>
        </el-table-column>
